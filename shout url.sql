...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1548745668ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=short+url&table=url">`short url`.`url`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=carpool&table=post">`carpool`.`post`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=carpool&table=user">`carpool`.`user`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="3c327932752b26395b59553a6c433851">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="carpool" targettable="user">
            ...
            Queried time
                            ...
                            targetdb="short url" targettable="url">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `short url`.`url` ( `id` INT(10) NOT NULL AUTO_INCREMENT ,  `original_url` VARCHAR(200) NOT NULL ,  `short_url` VARCHAR(60) NOT NULL ,  `date` TIMESTAMP NOT NULL ,  `quantity` INT(10) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="carpool" targettable="post">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `url` (`id`, `original_url`, `short_url`, `date`, `quantity`) VALUES (NULL, &#039;https://jigsawgroups.com/th/web-design-and-development&#039;, &#039;https://shrtco.de/9NRulh&#039;, current_timestamp(), &#039;1&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="short url" targettable="url">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `url`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="short url" targettable="url">
                            <div class="action_content">
